...
OWNER = int(environ.get("OWNER", "7307419667"))
CREDIT = environ.get("CREDIT", "Nitish_Bot's")
cookies_file_path = os.getenv("cookies_file_path", "youtube_cookies.txt")

TOTAL_USER = os.environ.get('TOTAL_USERS', '7307419667').split(',')
TOTAL_USERS = [int(user_id) for user_id in TOTAL_USER]

AUTH_USER = os.environ.get('AUTH_USERS', '7307419667').split(',')
